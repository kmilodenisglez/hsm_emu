...
class BaseProxy(object):
    ...
    def __init__(self,
        ...
        self.__conn = None
        authpair = None
        #print("BASEPROXY: ", self.__auth_header)
        ...
        if authpair is None:
            ...
            self.__auth_header = b"Basic " + base64.b64encode(authpair)# = None
        else:
            authpair = authpair.encode('utf8')
...
class RawProxy(BaseProxy):
    ...
    def __init__(self,
                 ...
                 timeout=DEFAULT_HTTP_TIMEOUT,
                 **kwargs):
        #print("RawProxy: ",btc_conf_file,service_port,service_url, service_port)
...
class Proxy(BaseProxy):
    ...
    def __init__(self,
                 ...
                 timeout=DEFAULT_HTTP_TIMEOUT,
                 **kwargs):
        #print("Proxy: ",btc_conf_file,service_port,service_url, service_port)
